<div class="sidebar p-2 py-md-3 @@cardClass">
    <div class="container-fluid">
      ...
      <div class="title-text d-flex align-items-center mb-4 mt-1">
        <h4 class="sidebar-title mb-0 flex-grow-1"><span class="sm-txt">M</span><span>ILLENNIUM</span></h4>
      ...
      <div class="main-menu flex-grow-1">
        <ul class="menu-list">
          <li class="divider py-2 lh-sm"><span class="small">ADMIN</span><br> <small class="text-muted">Millennium Group of Companies </small></li>
          <li class="collapsed">
          ...
          <li class="collapsed">
            ...
            <ul class="sub-menu collapse" id="menu-Applications">
              <li><a class="ms-link" href="app-blog.php">New Blog Post</a></li>
              <li><a class="ms-link" href="view-blog.php">View Blog Posts</a></li>
            </ul>
          </li>
        </ul>
        <!-- <ul class="menu-list">
